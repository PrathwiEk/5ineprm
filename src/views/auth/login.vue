<template>
  <div class="home">
                            ...
                            <div class="col m6 s12 pull-m6">
                                <div class="right-box">
                                    <div class="login-title center-align">
                                        <p class="center-align">Sign In</p>
                                    </div>
                                    <form @submit.prevent="loginCheck()">
                                        <div class="reg-form">
                                            <div class="input-field ">
                                                <input id="cname" required v-model="username"  type="email" class="validate">
                                                <label for="cname">User name or email id</label>
                                            </div>
                                            
                                            <div class="input-field ">
                                                <input id="cpsw" required v-model="psw"  type="password" class="validate">
                                                <label for="cpsw">Password</label>
                                                <span class="helper-text red-text">{{errormsg}}</span>
                                            </div>
                                            <div class="center-align pt5 have-account">
                                                <router-link to="/" class="left">Create an Account</router-link>
                                                <a class="right" @click="show()">Forgot Password</a>
                                            </div>
                                            <button type="submit" class="btn r-btn waves-effect waves-light">Login</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
    ...
    <modal name="hello-world" :delay="100" :height="250" :width="450"  :adaptive="true" >
        <div class="right-box">
            <div class="login-title center-align">
            ...
            <div class="reg-form">
                <div class="input-field ">
                    <input id="fpemial" type="email" class="validate">
                    <label for="fpemial">Enter email id</label>
                </div>
                <a class="btn r-btn waves-effect waves-light" @click="hide()">Submit</a>
            </div>
        </div>
    </modal>
  </div>
...
export default {
    ...
    methods: {
        ...
        loginCheck(){
            ...
            formData.append('usename', this.username);
            ...
            .then(res => {
                    if(res.data.status == 'true'){
                       ...
                       this.$store.dispatch('setlogin', userdata);
...
.form-container::before { content: ""; width: 50%; height: 100%; background: #2962ff; position: absolute; z-index: 0; right:0px}
